...
class HomeListBloc extends Bloc<HomeListEvent, HomeListState> {
  ...
  HomeListBloc() : super(const HomeListState()) {
    on<HomeListEventLoad>(_onPostFetched, transformer: throttleDroppable(throttleDuration));
  }

  Future<void> _onPostFetched(HomeListEvent event, Emitter<HomeListState> emit) async{
